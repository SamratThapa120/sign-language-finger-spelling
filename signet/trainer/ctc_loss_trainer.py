...
def train_conv1d_mhsa_ctc_model(experiment_name,CFG,train_files, valid_files=None):
    ...
    train_ds = get_tfrec_dataset(train_files, CFG,shuffle=32768,repeat=True,augment=True)
    valid_ds = get_tfrec_dataset(valid_files, CFG, shuffle=False,repeat=False,augment=False)
