...
class EncoderDecoderBase(Base):
    ONLY_WORLD_LENGTH=45
    MAX_WORD_LENGTH=ONLY_WORLD_LENGTH+1
    ...
    augment=True
    flip_lr_probability=0.4
    random_affine_probability=0.5
    freeze_probability=0.7
    tempmask_probability=0.2
    ...
    one_hot=False
    save_output = True
    output_dir = '../runs/encoder_decoder_tuning'
    
    seed = 42
    verbose = 1 #0) silent 1) progress bar 2) one line per epoch
    
    num_feature_blocks=9
    blocks_dropout=0.3

    replicas = num_devices
    lr = 0.00657174240959493
    weight_decay = 4.321400650382313e-06
    lr_min = 1.5e-06
    epoch = 100 
    train_epochs = 100
    warmup_epochs = 20
    ...
    decoder_blocks=1
    label_smoothing=0.016277723898216884
    final_dropout=0.2
    @classmethod
    def to_dict(cls):
